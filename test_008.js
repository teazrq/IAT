define(['https://pcplab.sfo2.digitaloceanspaces.com/common/qiat.js'], function (qiatExtension) {
    return qiatExtension({
        ...
        instAttributeInventory: [
            ...
            '<td style="width: 362px; height: 31px;"><span style="color: #00ffff;">Masculine Words/Phrases: </span></td>',
            '<td style="width: 35px; height: 31px;"><span style="color: #00ffff;"> </span></td>',
            '<td style="width: 366px; height: 31px;"><span style="color: #00ffff;">Feminine Words/Phrases: </span></td>',
            '</tr>',
        ...
        instAttributePractice: [
            ...
            'Words/phrases representing the categories at the top of the screen will appear one by one in the middle of the screen.<br>',
            'When the word/phrase belongs to a category on the left, press the D key.<br>',
            'When the word/phrase belongs to a category on the right, press the L key.<br><br></p>',
            '<p id="instructions">Each word/phrase belongs to only one category.<br>',
