define(['https://pcplab.sfo2.digitaloceanspaces.com/common/qiat.js'], function (qiatExtension) {
    return qiatExtension({
        ...
        instCategoryInventory: [
            '<div style="text-align:left">',
            '<p>These are the words/phrases you will need to classify now:</p>',
            '<table style="height: 238px; width: 779px;" cellspacing="10">',
            '<tbody style="color: #ffff00;">',
            '<tr style="height: 49px;">',
            '<td style="width: 362px; height: 49px;"><span >Masculine: </span></td>',
            '<td style="width: 35px; height: 31px;"></td>',
            '<td style="width: 366px; height: 49px;"><span>Feminine: </span></td>',
            '</tr>',
        ...
        instCategoryPracticeHinted: [
            ...
            'The words/phrases for sorting have changed as well. The rules, however, are the same.</p>',
            '<p id="instructions">Press either D or L to sort words/phrases to the categories on the screen.<br><br>',
            '<font color="#FFFF00"><b>In this part of the task, each word/phrase will include a categorization hint to help you learn the categories. Later, this hint will not be provided.</b></font><br>',
        ...
        instCategoryPractice: [
            '<div style="font-size: 22px; color: white; text-align: left;">',
            '<p id="instructions">',
            'Sort the words/phrases into the same two categories again.<br>',
